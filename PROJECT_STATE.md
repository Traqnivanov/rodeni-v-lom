...
2. Провеждат се четири реални end-to-end сценарийни теста: **Лом, Ковачица, Варна, малко населено място**.
3. За всеки се проверява: **първо отваряне → 3-секундно разбиране → Root/местна идентичност → Current → първа стойност → следващо действие → мотив за регистрация → как човекът може да стане полезен възел за R.E.**
4. Сравняват се резултатите със старите §§9, 58–60, 67, 69–70, 75, 79, 87 и §100.
5. Едва след тестовете се прави конкретно предложение за публичната архитектура **Лом ↔ България** и се иска Owner решение.
6. След Owner решение се прави dependency revalidation само на засегнатите екрани/текстове; проектът не започва отначало.
