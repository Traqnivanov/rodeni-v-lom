...
- точният технически механизъм за безопасно пренасяне на pre-registration Root + Current Location през registration и email confirmation;
...
- Следва точка 3 — безопасното и непрекъснато пренасяне на въведените Root + Current Location през registration и email confirmation.
