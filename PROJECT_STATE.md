...
2. Уточнява се точният продуктов договор на **R.E.** само дотолкова, доколкото е нужен за архитектурата.
3. След това се разглеждат възможните архитектури **първа реална общност Лом ↔ национален продукт България**.
4. След Owner решение се прави dependency revalidation само на засегнатите екрани/текстове; не се започва проектът отначало.
