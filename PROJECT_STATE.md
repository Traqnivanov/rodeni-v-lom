...
3. Следва **R.E. TEST 012 — „Защо да се регистрирам точно сега?“** в четири случая:
   - силен резултат;
   - общност без допустим човек;
   - почти нулева плътност;
   - конкретна активна нужда.
4. След това: **TEST 013 — първите 5 минути след регистрацията**.
5. Едва след доказан registration/post-registration value: **TEST 014 — естествен growth loop**.
