...
| Root | User избира точно canonical населено място. То определя exact Root; municipality се извежда автоматично и определя community membership. Exact locality е по-силен вътрешен signal; областта остава слаб резервен context | Master §§67, 70, 75, 115; official locality→municipality mapping; Context Engine; privacy; naming contract |
