...
| Public CTA | Одобрен default: „Виж какво има за теб“; **точният CTA в privacy-suppressed low-density state е ЗА ПОВТОРНА ПРОВЕРКА по §112/§114** | не обещава „Виж кои са“ или несъществуващ резултат; registration boundary остава → onboarding → „За теб“ |
...
| Public architecture „Лом ↔ България“ | **ОДОБРЕНО 25.09.2026:** една стабилна продуктова идентичност + Лом като видим origin/pilot + national Root scope + dynamic local context според Root; без автоматично `Родени в [Root]` rebrand | Master §§100, 112; не избира ново национално име и не заключва финален public copy |
| Screen 1 initial public state | **ЗА ПОВТОРНА ПРОВЕРКА на wording/low-density CTA и motive в вече одобрения national framing**; registration boundary остава, но точният CTA при suppressed low-density state може да се revalidate според §112 | Master §§67, 79, 82, 92, 96, 100, 112, 114; CURRENT NEXT е най-честният и полезен low-density CTA/motive вътре в същата registration boundary; без bypass и без странична промяна на privacy/aggregate contracts |
