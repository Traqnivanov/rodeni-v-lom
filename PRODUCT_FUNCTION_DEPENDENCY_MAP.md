...
| Screen 1 initial public state | **ЗА ПОВТОРНА ПРОВЕРКА само на wording/low-density motive в вече одобрения national framing**; одобреният flow и CTA не се променят от TEST 016 | Master §§67, 79, 82, 92, 96, 100, 112, 114; CURRENT NEXT е да се намери честно обяснение на registration motive при low density вътре в съществуващия flow; без нов route и без странична промяна на privacy/aggregate contracts |
