...
| Screen 1 initial public state | **ЗА ПОВТОРНА ПРОВЕРКА на wording/low-density motive в вече одобрения national framing**; privacy-safe world map + ясна кука остават посока, но Lom-centric copy от §92 не е автоматично валидна национална формулировка | Master §§67, 82, 92, 100, 112; CURRENT NEXT е low-density CTA / registration-motive test; не пипай privacy/aggregate contracts като страничен ефект |
